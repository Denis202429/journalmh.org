    ...
    <div class="container">
        <div class="row align-items-start g-4">
            <div class="col-lg-8">
                ...
                <div class="mb-5">
                    <h5 class="mb-3 pb-2 border-bottom" style="color: var(--primary);">
                        <i class="bi bi-tags me-2"></i> Тематические разделы журнала
                    </h5>
                    <p class="text-muted small mb-4">Созданы в соответствии с шифрами научных специальностей ВАК:</p>
                            ...
                            <div class="card h-100 border-0 shadow-sm">
                                <div class="card-body">
                                    <div class="d-flex align-items-center mb-2">
                                        ...
                                        <h6 class="card-title mb-0 fw-bold">5.6. Исторические науки</h6>
                                    </div>
                                    <ul class="small text-muted ps-3 mb-0">
                                        <li>5.6.1. Отечественная история</li>
                                        <li>5.6.3. Археология</li>
                                        <li>5.6.4. Этнология, антропология и этнография</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card h-100 border-0 shadow-sm">
                                <div class="card-body">
                                    <div class="d-flex align-items-center mb-2">
                                        ...
                                        <h6 class="card-title mb-0 fw-bold">5.9. Филология</h6>
                                    </div>
                                    <ul class="small text-muted ps-3 mb-0">
                                        <li>5.9.1. Русская литература и литературы народов РФ</li>
                                        <li>5.9.4. Фольклористика</li>
                                        <li>5.9.5. Русский язык. Языки народов России</li>
                                        <li>5.9.8. Теоретическая и сравнительно-сопоставительная лингвистика</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card h-100 border-0 shadow-sm">
                                <div class="card-body">
                                    <div class="d-flex align-items-center mb-2">
                                        ...
                                        <h6 class="card-title mb-0 fw-bold">5.10. Искусствоведение и культурология</h6>
                                    </div>
                                    <p class="small text-muted mb-0">
                                        5.10.3 Виды искусства (музыкальное искусство; театральное искусство;
                ...
                <p class="text-justify" style="color: var(--text-light); font-size: 1.05rem;">
                    ...
                    Адрес издателя: 428015, Чувашская Республика, город Чебоксары, Московский проспект, 29, корпус 1
                    <br>
                ...
                <div class="card border-0 shadow-sm h-100 rounded-4">
                    <div class="card-body p-4 p-lg-5 text-center text-md-start">
                        ...
                        <p class="text-secondary mb-0">
                            428015, Чувашская Республика,<br>
                            г. Чебоксары, Московский проспект, 29, корпус 1
                        </p>
                        <a href="https://yandex.ru/maps/-/CDxS7J2V" target="_blank" class="btn btn-sm btn-link ps-0 mt-2">
                ...
                <div class="card border-0 shadow-sm h-100 rounded-4">
                    <div class="card-body p-4 p-lg-5 text-center text-md-start">
                        <div class="bg-info bg-opacity-10 rounded-circle p-3 d-inline-flex mb-3">
                            <i class="bi bi-telephone-fill text-info fs-2"></i>
                        </div>
                        <h3 class="h5 fw-bold mb-2">Телефон</h3>
                        <p class="mb-0">
